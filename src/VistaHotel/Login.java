...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(LTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, 260, 50));

        jPanel2.setBackground(new java.awt.Color(33, 44, 116));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 140, 190, 20));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 370, 190, 40));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ContraseñaEV.png"))); // NOI18N
        jLabel3.setText("jLabel3");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, 50, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/UsuarioEV.png"))); // NOI18N
        jLabel4.setText("jLabel3");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 50, -1));

        jButton2.setBackground(new java.awt.Color(33, 44, 116));
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IniciarEV.png"))); // NOI18N
        jButton2.setText("INICIAR SESION");
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 190, 40));

        jPasswordField1.setText("*****");
        jPanel1.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 190, -1));
